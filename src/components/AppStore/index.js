...
class AppStore extends Component {
  ...
  UpdatedTabDetails = SearchResults => {
    const {ActiveTabId} = this.state
    const UpdateTab = SearchResults.filter(
  ...
  render() {
    ...
    const UpdateTabData = this.UpdatedTabDetails(SearchResults)
    ...
    return (
      <div className="container">
        ...
        <ul className="tabs-container">
          {tabsList.map(eachSection => (
            <TabItem
              key={eachSection.tabId}
              tabDetails={eachSection}
              SeparateEachSection={this.SeparateEachSection}
              isActive={eachSection.tabId === ActiveTabId}
            />
          ))}
        </ul>
        <ul className="apps-container">
          {UpdateTabData.map(eachList => (
